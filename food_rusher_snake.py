# Naive food-chaser reference opponent Battlesnake for local benchmarking and opponent-modeling tests
import os
import random
import logging
from flask import Flask, request

app = Flask("FoodRusherSnake")

@app.get("/")
def on_info():
    return {
        "apiversion": "1",
        "author": "FoodRusherBot",
        "color": "#E74C3C",  # Distinct vibrant red
        "head": "evil",
        "tail": "curled"
    }
...
def on_move():
    ...
    # 5. Greedy food pursuit: ALWAYS pick the safe move minimizing Manhattan distance to nearest food
    if food_list:
...
if __name__ == "__main__":
    ...
    print(f"Food Rusher Opponent Snake running on http://127.0.0.1:{port}")
